document.addEventListener('DOMContentLoaded', function() {
        ...
        const modulos = [
            ...
            { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128"><g transform="translate(0,128) scale(0.1,-0.1)" fill="currentColor"><path d="M294 1110 c-12 -4 -31 -20 -42 -35 -42 -53 -39 -75 41 -343 42 -138 83 -262 92 -275 33 -51 63 -57 309 -57 l227 0 24 -25 c14 -13 25 -35 25 -49 0 -77 -27 -86 -256 -86 -222 0 -250 8 -305 89 l-34 49 -43 -30 -42 -29 17 -31 c28 -49 90 -108 136 -129 37 -16 68 -19 270 -19 259 0 284 6 332 78 54 82 37 187 -39 248 -29 23 -36 36 -36 64 0 48 -30 100 -71 122 -28 15 -57 18 -171 18 l-137 0 -31 103 c-86 284 -93 300 -129 324 -35 24 -96 30 -137 13z"/></g></svg>', label: 'Butacas', desc: 'Asientos por sala', link: 'butacas.html', color: 'bg-success text-white' },
